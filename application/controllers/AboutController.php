...
(5) Data Publishing and Editorial Review: Open Context has now set up an editorial process to review datasets prior to publication. Rather than simply being “shared,” datasets disseminated through Open Context are first reviewed, edited, and annotated for formalized publication and archiving. Contributing researchers and editors collaborate to identify, track, and resolve issues, clean data, and create needed documentation. This gives datasets more value as intelligible and high-quality scholarly outputs.
